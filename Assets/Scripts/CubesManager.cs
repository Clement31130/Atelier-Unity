...
public class CubesManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < nbCubesCreate; i++)
        {
            ...
            cube.GetComponent<Move>().vitesseMax *= Random.Range(0.5f, 2.0f);
            cube.GetComponent<Move>().acceleration *= Random.Range(0.5f, 2.0f);
            ...
            {
                cube.GetComponent<Move>().target = cubePrev;
            }
